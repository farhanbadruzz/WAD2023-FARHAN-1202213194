...
// silakan taruh code kalian di bawah
    if(empty($tinggi_badan) || empty($berat_badan)){
        $error_messages = "Tinggi badan dan berat badan tidak boleh kosong.<br>Silakan isi dua kolom dengan lengkap!";
    }
...
// silakan taruh code kalian di bawah
    if (empty($error_messages)){
        $tinggi_badan_dalam_meter = $tinggi_badan/100;
        $hitung_bmi = $berat_badan/($tinggi_badan_dalam_meter**2);
    }
}
// **********************  3  ************************** 
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if(isset($hitung_bmi)){
                        ...
                        echo "Hasil BMI: " . $hitung_bmi . "<br>";
                            
                        if($hitung_bmi<=18.4){
                            echo "Status BMI: Underweight";
                        } elseif (18.5<=$hitung_bmi && $hitung_bmi<=24.9){
                            echo "Status BMI: Normal";
                        }elseif (25.0<=$hitung_bmi && $hitung_bmi<=39.9){
                            echo "Status BMI: Overweight";
                        } else {
                            echo "Status BMI: Obese";
                        }
                    }
                    ?>
                    <!--  **********************  4  **************************     -->
